...
Set up eslint in your project so that you can perfom linter checks by running `npm run lint`. To get most of linting it is also recommended to integrate eslint with your editor.
